  ...
  <div class="flex-shrink-0">
    ...
    <div id="body">
      <form>
        <div class="row g-3 mb-3">
          <div class="col-md-2">
            <div class="d-flex align-items-start">
              <img
                v-if="formData.updatedAvatar"
                :src="formData.updatedAvatar"
                class="rounded"
                alt="Preview of uploaded image"
                id="profile-image-prev"
              />
              <img
                v-else
                :src="
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-12">
            <label for="profile-edit-image" class="form-label"
              >Profile Image</label
            >
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            <label for="profile-edit-username" class="form-label"
              >Username</label
            >
            <input
              type="text"
          ...
          <div class="col-md-6">
            <label for="profile-edit-full-name" class="form-label"
              >Full Name</label
            >
            <input
              type="text"
        ...
        <div class="row g-3 mb-3">
          ...
          <div class="col-md-6">
            <label for="profile-edit-dob" class="form-label"
              >Date of Birth</label
            >
            <input
              type="date"
        ...
        <div class="mb-3">
          ...
          <div v-for="item in categories" :key="item">
            <CustomCheckbox
              :category="item"
              :isChecked="userData.categories.includes(item)"
            />
          </div>
        </div>
      </form>
